        ...
        <div className="section2">
          ...
          <div className="team">
            <div className="container23">
              <Link href="/profile">
                <a className="link">
                  <div className="container24 thqLink">
                    <MemberDetails image_src="/playground_assets/team1-1000h.jpg"></MemberDetails>
              ...
              <Link href="/profile">
                <a className="link1">
                  <div className="container29 thqLink">
                    <MemberDetails
                      heading1="Romina Hadid"
                      heading11="Marketing Specialist"
                      image_src="/playground_assets/team2-1000h.jpg"
                    ></MemberDetails>
              ...
              <Link href="/profile">
                <a className="link2">
                  <div className="container33 thqLink">
                    <MemberDetails
              ...
              <Link href="/profile">
                <a className="link3">
                  <div className="container38 thqLink">
                    <MemberDetails
                      heading1="Jenna Kardi"
                      heading11="Founder and ceo"
                      image_src="/playground_assets/team4-1000h.png"
                    ></MemberDetails>
            ...
            <div className="contact">
              ...
              <div className="form">
                ...
                <input
                  ...
                  className="textinput textSM thqTextInput"
                />
                <span className="text54 textXS">EMAIL</span>
                <input
                  type="text"
                  placeholder="Email"
                  className="textinput1 textSM thqTextInput"
                />
                ...
                <textarea
                  ...
                  className="textarea textSM thqTextArea"
                ></textarea>
